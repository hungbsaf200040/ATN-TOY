...
<body>
  ...
  <form class="row container mx-auto py-3" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="file" class="form-control" id="prod_img" value="<?php echo $product["thumbnail"] ?>"
        name="thumbnail">
      <img src="<?php echo $baseURL . '/' . $product["thumbnail"]; ?>" class="mt-3" alt="preview" width="200"
        height="200" />
    </div>
    <?php } ?>
